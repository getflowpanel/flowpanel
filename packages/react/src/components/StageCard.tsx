  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--fp-text-2)" }}>
          {stage}
        </span>
      </div>
      <div className="fp-mono" style={{ fontSize: 36, fontWeight: 700, color: "var(--fp-text-1)", lineHeight: 1, marginBottom: 8 }}>
