...
import { countCoreInstances, firstDiagnostics, fixPrecondition, staleEjectMarkers } from "./probes";
import { FIXABLE_FILES, MIGRATION_REL_DEST, makeFix } from "./templates";
