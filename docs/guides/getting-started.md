...
option set is `ResourceOptions<Row>` — see `docs/reference/resources.md`.
...
Full reference: `docs/reference/realtime.md`.
...
- `docs/reference/resources.md` — columns, filters, drawer, scope, audit
- `docs/reference/dashboard.md` — sections, widget builders, dateRange
- `docs/reference/actions.md` — `RowAction`, `BulkAction`, `ActionResult`
- `docs/reference/adapters.md` — Drizzle/Prisma feature matrix
