...
[`metric(label, query, options?)`](./dashboard.md#metriclabel-query-options),
...
`@flowpanel/charts` directly; see `dashboard.md`.

Tracking issue: see [ROADMAP.md](../../ROADMAP.md) for the metric
helper module under post-1.0 work.
