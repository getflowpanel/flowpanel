---
title: 'Typing ctx.db'
description: 'Augment FlowpanelTypes once to get a fully typed ctx.db across every widget, action, and resource callback.'
---
...
- [Resources](../resources/) — full `ResourceOptions<Row>` shape
- [Dashboards](../dashboard/) — `WidgetContext.db`
- [Adapters](../adapters/) — Drizzle / Prisma adapter wiring
