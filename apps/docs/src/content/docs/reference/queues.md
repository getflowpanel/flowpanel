---
title: 'Queues'
description: 'FlowPanel ships with first-class queue inspection and control. Today there''s a BullMQ adapter; the `QueueAdapter` interface makes adding more (pgmq, SQS, Inngest…) a small package.'
---
