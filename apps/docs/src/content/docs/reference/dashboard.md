---
title: 'Dashboard'
description: 'A dashboard is a page of widget sections, registered in defineAdmin({ dashboards }).'
---
...
`resource.<name>` channels fire automatically on any mutation through that resource (see [Realtime](../realtime/)).
