...
description: 'Built-in ⌘K palette with navigation, theme toggle, and user-defined groups.'
---
...
- [Shell](../shell/) — the chrome that hosts the palette
- [Theme](../theme/) — `toggleTheme()` runtime and `useTheme()` hook
