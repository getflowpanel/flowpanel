---
title: 'Shell'
description: 'The chrome around your admin content area — sidebar, tabs, or bare. Mobile responsive.'
---
...
- [Theme](../theme/) — `theme.brand`, component overrides, dark mode
- [Command palette](../command-palette/) — built-in groups and config
