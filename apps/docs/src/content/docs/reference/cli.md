---
title: 'CLI'
description: 'The flowpanel CLI: init, migrate, doctor, eject, dev, new.'
---
...
- [Getting started](../../getting-started/) — full bootstrap walkthrough
- [Adapters](../adapters/) — Drizzle / Prisma config shapes
